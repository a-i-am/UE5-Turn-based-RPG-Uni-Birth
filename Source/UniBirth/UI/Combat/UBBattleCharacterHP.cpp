#include "UI/Combat/UBBattleCharacterHP.h"
...
void UUBBattleCharacterHP::NativeConstruct()
{
...
void UUBBattleCharacterHP::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void UUBBattleCharacterHP::UpdateHPBar(float NewCurrentHP, float max)
{
...
void UUBBattleCharacterHP::UpdateMPBar(float NewCurrentMP, float max)
{
	if (max <= 0.0f)
	{
		return;
...
void UUBBattleCharacterHP::UpdateShieldBar(float NewCurrentShield, float max)
{
