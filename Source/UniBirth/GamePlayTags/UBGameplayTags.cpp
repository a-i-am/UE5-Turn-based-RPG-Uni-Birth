#include "UBGameplayTags.h"

namespace UBGameplayTags
{
    UE_DEFINE_GAMEPLAY_TAG(Action_Attack_Normal, "Action.Attack.Normal");
    UE_DEFINE_GAMEPLAY_TAG(Action_Attack_Skill, "Action.Attack.Skill");
    UE_DEFINE_GAMEPLAY_TAG(Action_Attack_Ultimate, "Action.Attack.Ultimate");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Action_Hit, "Action.Hit");
